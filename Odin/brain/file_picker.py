...
class FilePicker:
    ...
    def process_file(self, file_path):
        """
        Process the file into separate chunks and add file-level identifiers to the first and last chunks.
        """
        try:
            ...
            # Stage 2: Batch train all chunks
            self.conversation_manager.batch_process_queries(chunks)
